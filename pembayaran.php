	...
	<div class="kontainer mt-4">
		<div class="row konten-baris-tengah">
			...
			<div class="kolom-md-7">
				...
				<b>No Rek : 123456789 (Bank BCA, Atas Nama : Toko Electonic Goods and Services)</b>
				<br>
				<br>
	...
	WHERE pembelian.idbeli='$_GET[id]'");
		...
		<div class="row">
			<div class="kolom-md-6">
				...
				Pemasangan : Rp. <?php echo number_format($detail['ongkir']); ?><br>
				Total Bayar : Rp. <?php echo number_format($detail['ongkir'] + $detail['totalbeli'] + $detail['hargapemasangan']); ?>
			</div>
			<div class="kolom-md-6">
