...
<head>
  <title>Pet Care Makassar</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <link rel="stylesheet" href="css/animate.css">
  <link rel="stylesheet" href="css/style.css">
  <link rel="stylesheet" href="css/gaya.css">
  <link rel="icon" type="image/x-icon" href="foto/tapak.png">
  <link href="admin/css/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
</head>

<body>

  <nav class="jaraklogoatas" id="ftco-navbar" style="background-color: #FFFF99;color:white">

    <center>
      <a href="index.php"><img width="50px" src="foto/tapak.png"></a>
    </center>
