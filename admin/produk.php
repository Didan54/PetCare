	...
	<a href="index.php?halaman=tambahproduk" class="tombolkecil kanan" style="background-color: #4c60da">Tambah Produk</a>
			...
			<tbody>
				...
				<?php while ($pecah = $ambil->fetch_assoc()) { ?>
					<tr>
						...
						<td>
							<a href="index.php?halaman=ubahproduk&id=<?php echo $pecah['idproduk']; ?>" class="tombolkecil" style="background-color: #4c60da">Ubah</a>
