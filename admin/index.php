...
<body class="w3-light-grey w3-content" style="max-width:1600px">
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-animate-left" id="mySidebar" style="background-color: #4c60da">
        ...
        <a href="index.php?halaman=beranda" class="w3-bar-item w3-button w3-hover-black" style="background-color: #99b4fb;color:white;">DASHBOARD</a>
        <br>
        <a href="index.php?halaman=produk" class="w3-bar-item w3-button w3-hover-black" style="background-color: #99b4fb;color:white;">DATA PRODUK</a>
        <br>
        <a href="index.php?halaman=kategori" class="w3-bar-item w3-button w3-hover-black" style="background-color: #99b4fb;color:white">DATA KATEGORI</a>
        <br>
        <a href="index.php?halaman=pembelian" class="w3-bar-item w3-button w3-hover-black" style="background-color: #99b4fb;color:white">DATA TRANSAKSI</a>
        <br>
        <a href="index.php?halaman=logout" onclick="return confirm('Apakah Anda Yakin Ingin Keluar ?')" class="w3-bar-item w3-button w3-hover-black" style="background-color: #99b4fb;color:white">LOGOUT</a>
    </nav>
