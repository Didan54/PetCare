...
<div class="w3-section w3-padding-16">
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-grup">
			...
			<input type="number" class="bentukform" name="berat">
		</div>
		<div class="form-grup">
...
if (isset($_POST['save'])) {
	...
	$koneksi->query("INSERT INTO produk
		(namaproduk,id_kategori,hargaproduk,beratproduk,fotoproduk,deskripsiproduk,stokproduk)
		VALUES('$_POST[nama]','$_POST[id_kategori]','$_POST[harga]','$_POST[berat]','$namafoto','$_POST[deskripsi]','$_POST[stok]')");
